...
save_path <- "/Users/michaelpasala/Research/Results/Within-50/"
...
# laptop
root_dir = paste0("/Users/michaelpasala/Research/MovementLab/dataR/", cond) #15Rats
...
num_iterations <- iter  # should go up on TACC
...
if (save_flag) {
  ...
  fname_str <- paste0(save_path, n_files, "RatsBootSummary.RData") 
