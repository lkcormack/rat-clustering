...
folder_path <- '/scratch/09634/michaelp3844/Run/data'
save_path <- '/scratch/09634/michaelp3844/'
...
dir_list <- dir(root_dir, full.names = TRUE, recursive = TRUE)
...
num_iterations <- iterations  # should go up on TACC
